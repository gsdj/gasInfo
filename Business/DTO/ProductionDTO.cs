...
namespace Bussiness.DTO
{
   public class ProductionDTO
   {
      ...
      public int Cb1Cb2 => (Cb1 + Cb2);
      public int Cb3Cb4 => (Cb3 + Cb4);
      public int Cb5Cb6 => (Cb5 + Cb6);
      public int Cb7Cb8 => (Cb7 + Cb8);
      public int Cb1Cb6 => (Cb1Cb2 + Cb3Cb4 + Cb5Cb6);
      public int MK => (Cb1Cb6 + Cb7Cb8);

      //Про-во кокса вал.
      public decimal Cb16Val { get; set; }
      public decimal Cb78Val { get; set; }
      public decimal CbTnVal => Cb16Val + Cb78Val;

      //Про-во кокса сух.
      public decimal Cb16Dry { get; set; }// => Math.Round((Cb16Val * Cb18C), 4);
      public decimal Cb78Dry { get; set; }// => Math.Round((Cb78Val * Cb18C), 4);
      public decimal TnDry => (Cb16Dry + Cb78Dry);
      ...
      public decimal TnConsDry => (Cb16ConsDry + Cb78ConsDry);
      ...
      //Расход шихты в с.в.
      public decimal Cb16Sv => Cb16ConsDry;
      public decimal Cb78Sv => Cb78ConsDry;
