...
namespace BLL.Services.Reporting
{
   public class ProductionService : IProductionService
   {
      ...
      public IEnumerable<ProductionDTO> GetItemsByMonth(DateTime Date)
      {
         ...
         return CalcProduction.CalcEntities(db.AmmountCb.GetPerMonth(Date.Year, Date.Month).ToList());
      }
      ...
      public IEnumerable<ProductionDTO> GetItemsByNowMonth()
      {
         ...
         return CalcProduction.CalcEntities(db.AmmountCb.GetPerMonth(dateNow.Year, dateNow.Month).ToList());
      }
